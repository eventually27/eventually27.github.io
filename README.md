...
* **(On-Going)Development of 40-inch-class adaptive light field display technology with a 120-degree field of view utilizing active optical elements and deep learning-based real-time light field content rendering (2025~2029,Director)**
* **(On-Going)Development of a Prototype for a Per-pixel Focus Control Spatial AR Display, (2025-2026,Participation)**
* **(On-Going)Development of Holo-TV Core Technologies for Hologram Media Services (2022~2029,Participation)**
...
5. "Analysts in effects of aperture size and applied voltage on the response time", Yookwang Kim, Jin Su Lee, and Yong Hyub Won, proceedings in *SPIE Photonics West OPTO*, San Francisco, USA, March, 2016.
6. "Novel volumetric 3D display based on point light source optical reconstruction using multi focal lens array", Jin su Lee, Muyoung Lee, Junoh Kim, and Cheoljoong Kim, Yong Hyub Won, proceedings in *SPIE Photonics West OPTO*, San Francisco, USA, Feb 7, 2015.
7. "Realization of integral 3-dimensional image using fabricated tunable liquid lens array", proceedings in Muyoung Lee, Junoh Kim, Cheol Joong Kim, Jin Su Lee, and Yong Hyub Won, *SPIE Photonics West OPTO*, San Francisco, USA, Feb 7, 2015.
...
3. Apparatus for holographic image evaluation and method thereof, 10-2021-0004039, Korea
4. Polarization analysis apparatus and method for lens quality inspection, and polarization analysis system using the same, 10-2020-0184874, Korea
5. Volumetric three dimensional display apparatus using electrowetting liquid lens array, 10-1762391-0000, Korea.
6. Micro electrowetting varifocal liquid lens array and method for injecting fluid in the chamber, 10-2015-0157552, Korea.
7. Three dimensional display using hologram optical element, 10-2014-0041697, Korea.
8. Optical measurement system of three-dimensional display, 10-2014-0041691, Korea.
